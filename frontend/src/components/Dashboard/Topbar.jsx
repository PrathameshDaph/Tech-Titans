      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-1.5 sm:gap-2 lg:gap-3 w-full min-w-0">
        ...
        <div className="flex items-center justify-between gap-1.5 sm:gap-2 shrink-0 min-w-0 w-full lg:w-auto">
          ...
          <div className="flex lg:hidden items-center gap-1 sm:gap-1.5 shrink-0">
            {/* Live Clock */}
            <div className="flex items-center gap-1 px-1.5 py-1 rounded-xl bg-slate-50 border border-cyan-200 shadow-2xs shrink-0">
              <span className="text-[8px] uppercase font-black text-cyan-600 tracking-wider">LIVE</span>
            ...
            <div className="flex items-center bg-slate-100 p-0.5 rounded-xl border border-slate-200 shadow-inner shrink-0">
              ...
              <div className="flex items-center ml-0.5 border-l border-slate-200 pl-0.5">
                <button
                  onClick={() => onSetSpeed(speed === 1.0 ? 2.0 : 1.0)}
                  className="px-1.5 py-0.5 text-[10px] font-bold rounded-md bg-cyan-600 text-white shadow-xs"
                >
                  {speed}x
                </button>
              </div>
              ...
              <button
                onClick={onResetSim}
                className="p-1 ml-0.5 text-slate-500 hover:text-rose-600 hover:bg-slate-200/70 rounded-lg transition-colors"
            ...
            <button
              ...
              className="flex items-center gap-1 px-2 py-1.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-[11px] font-bold text-white shadow-md shadow-cyan-600/20 border border-cyan-500/30 transition-all hover:shadow-lg active:scale-95 whitespace-nowrap shrink-0"
        ...
        <div className="hidden lg:flex items-center gap-1.5 lg:gap-2 shrink-0">
          ...
          {/* Live Event Clock */}
          <div className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1 rounded-xl bg-slate-50 border border-cyan-200 shadow-2xs shrink-0">
